...
//        return Math.abs(y - mStartY) > Math.abs(x - mStartX) ? x < mPivotX != y > mStartY : y < mPivotY == x > mStartX;
    ...
    /**
     * 设置轴承是否可以跟随Item旋转 当 {@link BearingType} =  {@link #TYPE_VIEW} 时有效
     */
    ...
    /**
     * 指定轴承半径 {@link BearingType} =  {@link #TYPE_COLOR} 时有效
     */
    ...
    /**
     * 指定轴承的布局id 当 {@link BearingType} =  {@link #TYPE_VIEW} 时需设置
     */
    ...
    /**
     * 设置轴承颜色  {@link BearingType} =  {@link #TYPE_VIEW} 时有效
     */
    ...
    /**
     * item的布局方式: 默认:  {@link #MODE_AVERAGE}(平均)
    ...
    /**
     * 指定Item的偏移角度  {@link LayoutMode} =  {@link #MODE_FIXED} 时有效
     */
